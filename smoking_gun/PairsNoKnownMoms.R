...
if(FALSE) {  ### ECA IS COMMENTING THIS GUI CRAP OUT!! 
#				 PressedOK2 <- function()     {
...
# THERE IS NO MORE TK/TCL CRAP AFTER THIS POINT, EXCEPT WHAT I COMMENTED OUT BELOW.

# ECA:  ALL THE CRAP UP TO THIS POINT WAS TO DRIVE THE GUI AND APPARENTLY ASSIGN VALUES TO A SMALL
...
# ECA HAS NO IDEA HOW directory WAS USED.  SO, I WILL JUST SETWD HERE TO WHERE I WANT STUFF TO GO:
setwd("/tmp/SOLID")
...
adults <- read.table("dads4solo.txt", header=T, sep="\t", na.strings="-1", dec=".", strip.white=TRUE) 
offspring <- read.table("kids4solo.txt", header=T, sep="\t", na.strings="-1", dec=".", strip.white=TRUE)
...
# ECA: DON'T UNLINK THESE! I WANT TO KNOW WHAT IS IN THEM!
...
## SO I AM GOING TO COMMENT OUT ALL THIS BULLSHIT AND REMOVE THE BRACES AROUND THE PRESSED OK
## FUNCTION SO I CAN JUST RUN IT ALL WITHOUT THE DAMN GUI!!
